...
router.post('/v4/documents-checked-3', function (req, res) {
    ...
    //1 document from Group 1 AND 2 or more documents are selected from Group 2 - END journey 
     /* Route 1
    */
     if ((req.session.data['selectedDocs'] == "1") && (req.session.data['group2Docs'] >= "2")) {
...
router.post('/v4/documents-checked-4', function (req, res) {
    ...
    * Route 1
    */
    if((req.session.data['selectedDocs'] == "1") && (req.session.data['group3Docs'] >= "2")) {
    ...
    */
    ...
    /* Route 1
    */
    else if(req.session.data['selectedDocs'] >= "1"){
