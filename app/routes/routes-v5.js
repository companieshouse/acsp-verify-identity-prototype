 ...
 * llokup  address
 */
router.post('/v5/check-standard-met', function (req, res) {
 ...
 * UK national 
 */
router.post('/v5/documents-checked-1', function (req, res) {
 ...
 * Group 1
 */
router.post('/v5/documents-checked-2', function (req, res) {
 ...
 * Group 2
 */
router.post('/v5/documents-checked-3', function (req, res) {
 ...
 * address
 */
router.post('/v5/documents-checked-11', function (req, res) {
 ...
 * address
 */
router.post('/v5/documents-checked-6', function (req, res) {
...
router.post('/v5/documents-checked-12', function (req, res) {
 ...
 * address unsual
 */
router.post('/v5/documents-checked-7', function (req, res) {
 ...
 */
router.post('/v5/documents-checked-8', function (req, res) {
 ...
 */
router.post('/v5/documents-checked-10', function (req, res) {
...
router.get('/v5/zzz', function (req, res) {
    // Set URl
    res.render('/v5/zzz', {
  ...
  router.post('/v5/zzz', function (req, res) {
  ...
  // ******* oe-details validation ********************************
      ...
      res.redirect('/v5/pre-one-login/resident')
    }
  })
